...
class ResNetSkriptGen(nn.Module):
    """
    Adapted ResNet as shown in this code to fit the description of the PolyGen Image encoder (Table 4 in the Paper).
    Used as encoder for SkriptGen
    """
    def __init__(
        self,
        block: Type[Union[BasicBlock, Bottleneck, BottleneckOriginal]],
        layers: List[int],
        latent_vector_length: int = 256,
        zero_init_residual: bool = False,
        groups: int = 1,
        width_per_group: int = 64,
        replace_stride_with_dilation: Optional[List[bool]] = None,
